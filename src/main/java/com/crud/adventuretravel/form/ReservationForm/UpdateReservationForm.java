...
public class UpdateReservationForm extends FormLayout {
    ...
    public UpdateReservationForm(ReservationView reservationView) {
        ...
        update.addClickListener(event -> {
            ...
            try {
                update(tourId, customerId, selectedAttractionsSet, selectedDate, selectedPaymentStatus, selectedReservationStatus);
            } catch (BackendRequestException e) {
                errorNotification.showNotification("Reservation doesn't exist!");
            }
        });
        ...
        add(tourComboBox, customerComboBox, reservationDate, paymentStatusComboBox,
    ...
    private void update(long tourId, long customerId, Set<AttractionDto> selectedAttractionsSet,
        ...
        reservationService.updateReservationDto(reservationDto);
        reservationView.refresh();
        setReservationDto(null);
    }
